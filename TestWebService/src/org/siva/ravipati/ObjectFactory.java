 ...
 * generated in the org.siva.ravipati package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetServerName_QNAME = new QName("http://ravipati.siva.org/", "getServerName");
    private final static QName _GetServerNameResponse_QNAME = new QName("http://ravipati.siva.org/", "getServerNameResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.siva.ravipati
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ravipati.siva.org/", name = "getServerName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ravipati.siva.org/", name = "getServerNameResponse")
