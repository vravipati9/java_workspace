...
public class ShopInfoServiceLocator extends org.apache.axis.client.Service implements com.testMart123.www.ShopInfoService {
    ...
    private java.lang.String ShopInfoPort_address = "http://itpcitd42:8888/javabrainsWebServices/ShopInfoService";
    ...
    public com.testMart123.www.ShopInfo getShopInfoPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.testMart123.www.ShopInfo getShopInfoPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.testMart123.www.ShopInfoPortBindingStub _stub = new com.testMart123.www.ShopInfoPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.testMart123.www.ShopInfo.class.isAssignableFrom(serviceEndpointInterface)) {
                com.testMart123.www.ShopInfoPortBindingStub _stub = new com.testMart123.www.ShopInfoPortBindingStub(new java.net.URL(ShopInfoPort_address), this);
                _stub.setPortName(getShopInfoPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://www.testMart123.com", "ShopInfoService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://www.testMart123.com", "ShopInfoPort"));
        }
