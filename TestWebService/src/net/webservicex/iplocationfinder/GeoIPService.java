    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(net.webservicex.iplocationfinder.GeoIPService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = net.webservicex.iplocationfinder.GeoIPService.class.getResource(".");
